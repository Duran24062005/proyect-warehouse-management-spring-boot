...
public class UserController {
    ...
    @ApiResponses(
        value = {
            ...
            @ApiResponse(responseCode = "400", description = "Invalid image or malformed request"),
            @ApiResponse(responseCode = "401", description = "Authentication required")
        }
    )
    @Operation(summary = "Carga la foto de perfil del usuario autenticado")
    public ResponseEntity<UserResponseDTO> uploadProfilePhoto(@RequestParam("file") MultipartFile file) {
