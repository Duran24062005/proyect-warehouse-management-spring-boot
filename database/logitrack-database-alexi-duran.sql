DROP DATABASE IF EXISTS logitrack_alexi;

CREATE DATABASE IF NOT EXISTS logitrack_alexi
...
CREATE TABLE IF NOT EXISTS app_user (
    ...
    INDEX ix_app_user_warehouse (warehouse_id)
) ENGINE=InnoDB;
...
CREATE TABLE IF NOT EXISTS warehouse (
    ...
    INDEX ix_warehouse_manager (manager_user_id),
...
CREATE TABLE IF NOT EXISTS product (
    ...
    INDEX ix_product_warehouse (warehouse_id),
...
CREATE TABLE IF NOT EXISTS audit_change (
    ...
    INDEX ix_audit_entity_date (affected_entity_id, created_at),
...
CREATE TABLE IF NOT EXISTS movement (
    ...
    INDEX ix_movement_date (created_at),
    INDEX ix_movement_registered_by_date (registered_by_user_id, created_at),
    INDEX ix_movement_performed_by_date (performed_by_employee_id, created_at),
    INDEX ix_movement_product_date (product_id, created_at),
...
INSERT INTO app_user (
    ...
    (1, 'admin@logitrack.com', '$2a$10$adminhashlogitrack', 'Alexi', 'Duran', '3000000001', 'ADMIN', TRUE, 'ACTIVE', 'user-1-admin.jpg', NULL, '2026-03-01 08:00:00'),
    (2, 'mlopez@logitrack.com', '$2a$10$mlopezhashlogitrack', 'Maria', 'Lopez', '3000000002', 'USER', TRUE, 'ACTIVE', 'user-2-maria.jpg', NULL, '2026-03-01 08:10:00'),
    (3, 'jgarcia@logitrack.com', '$2a$10$jgarciahashlogitrack', 'Juan', 'Garcia', '3000000003', 'USER', FALSE, 'PENDING', NULL, NULL, '2026-03-01 08:20:00'),
    (4, 'cperez@logitrack.com', '$2a$10$cperezhashlogitrack', 'Camila', 'Perez', '3000000004', 'USER', FALSE, 'BLOCKED', NULL, NULL, '2026-03-01 08:30:00');
...
INSERT INTO app_user (
    ...
    (5, 'lrojas@logitrack.com', '$2a$10$lrojashashlogitrack', 'Luis', 'Rojas', '3000000005', 'EMPLOYEE', TRUE, 'ACTIVE', 'user-5-luis.jpg', 1, '2026-03-01 09:25:00');
